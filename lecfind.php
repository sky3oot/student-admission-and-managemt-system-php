        ...
        <div class="container-fluid">
            <div class="row">
                <ul class="nav  nav-justified" style="background-color:#FFF;">
                    ...
                    <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="lecinfo.php"><strong>lecture Information</strong></a></li>
                    <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="lecfind.php"><strong>Lecture Search</strong></a></li>
            ...
            <div class="row">
                ...
                <table style="background-color: rgba(255,255,255,0.0);" class="table table-responsive" width="500" border="0">
                    <form action="" method="post">
                        <tr>
                            <td><input style="font-size:12px" type="text" name="search" class="form-control" placeholder="Enter Student Registration No / id number/ Email /" />
                            </td>
                        </tr>
                        <tr align="center">
        ...
        <div class="container">
            <div class="row">
                ...
                if (isset($_POST['filter'])) {
                    $search = ($_POST['search']);
                    $self_query = "SELECT * FROM `lecture` WHERE concat(`id`,`name`,`surname`) like '%$search%' ORDER BY `id` DESC";
                    ...
                    while ($row = mysqli_fetch_array($result)) { ?>
                        ...
                        <div style="padding:20px;  margin:5px; border-radius:5px; background-color:rgba(255, 255, 255, 0.3);" class="col-md-5 col-md-push-1">
                            ...
                            <h4 style=" color:">
                                Reg.No : <?php echo $row["id"]; ?><br />
                                Lecture Name : <?php echo $row["name"]; ?> <?php echo $row["surname"]; ?><br />
                                Lecture Contact : <?php echo $row["contact"] ?>
                            </h4>

                            <dl class="dl-horizontal">

                                <dt style="font-size:12px;"><strong>Status : </strong></dt>
                                <dd style="font-size:12px;"><?php echo $row["status"]; ?></dd>
