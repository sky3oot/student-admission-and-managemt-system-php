...
<body>
    ...
    <main>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <div class="page-header">
                        <h3 style="font-family:calibri;" class="text-center">All Student details</h3>
                    </div>
                </div>
            </div>
        </div>
        <div style="border-radius:10px; padding:25px;" class="container alert-success">
            <div class="row">
                <div class="col-md-12 ">
                    <h4 style="font-family:calibri;" class="text-center">By clicking more information can get informtion
                    </h4>
                    <br />
                    ...
                    <table style="background-color:#FFF; font-size:12px; " class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th valign=""><strong>Student Number</strong></th>
                        ...
                        <tbody>
                            <?php
                            $count = 1;
                            $sel_query = "SELECT * FROM `admission` ORDER BY `id` DESC ";
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $row["idnumber"]; ?> </td>
