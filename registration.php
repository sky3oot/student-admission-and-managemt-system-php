...
<head>
    ...
    <meta charset="Convert to UTF-8 without BOM">
                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text">
                                    <p>The cure for boredom is curiosity.Parker<br>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php include('admission/controller.php'); ?>
    ...
    <footer>
        <div class="container">
            <div class="row">
                    ...
                    <div class="widget">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="?a=view">Calender</a></li>
                ...
                <p class="copy-right">Copyright &copy;2021</p>
            </div>
        </div>
    </footer>
